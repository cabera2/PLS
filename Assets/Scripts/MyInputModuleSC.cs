...
namespace UnityEngine.EventSystems
{
    ...
    /// </remarks>
    public class MyInputModuleSC : PointerInputModule
    {
        public Vector2 move;
        ...
        protected bool SendSubmitEventToSelectedObject()
        {
            ...
            if (input.GetButtonDown(m_SubmitButton) || Input.GetKeyDown(SysSaveSC._Keys[9]))
                ExecuteEvents.Execute(eventSystem.currentSelectedGameObject, data, ExecuteEvents.submitHandler);

            if (input.GetButtonDown(m_CancelButton) || Input.GetKeyDown(SysSaveSC._Keys[10]))
        ...
        private Vector2 GetRawMoveVector()
        {
            ...
            move.x = input.GetAxisRaw(m_HorizontalAxis) + _LeftPressed + _RightPressed;
            move.y = input.GetAxisRaw(m_VerticalAxis) + _UpPressed + _DownPressed;
